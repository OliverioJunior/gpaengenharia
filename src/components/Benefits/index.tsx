      ...
      <div>
        <section>
          ...
          <p>
            ...
            destacou em recente pesquisa que as perdas de materiais em uma obra
            chegam a 8%. Esse percentual é ainda maior se considerarmos as
            perdas financeiras, que envolvem inclusive custos de retrabalho,
            chegando a 30%.
          </p>
        </section>
        <section>
